...
import { Twitter, MessageCircle, Users, BookOpen, FileText, Code, TrendingUp, Database } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <span className="text-xs text-cyan-400 font-mono group-hover:underline">View Docs →</span>
            </a>
            ...
            >
              ...
              <span className="text-xs text-purple-400 font-mono group-hover:underline">Read Guide →</span>
            </a>
            ...
            >
              ...
              <span className="text-xs text-green-400 font-mono group-hover:underline">Learn More →</span>
            </a>
            ...
            >
              ...
              <span className="text-xs text-blue-400 font-mono group-hover:underline">View Schema →</span>
            </a>
          </div>
