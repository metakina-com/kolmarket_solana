        ...
        <main className="min-h-screen bg-background text-foreground relative overflow-hidden">
            ...
            <div className="pt-24 px-4 sm:px-6 lg:px-8 max-w-[1600px] mx-auto grid grid-cols-12 gap-6 pb-24 lg:pb-12">
                ...
                <aside className="hidden lg:block lg:col-span-4 order-1 space-y-6">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-muted-foreground font-mono tracking-widest uppercase">Neural Vector Engine v4.0</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="p-4 bg-card/50 border border-border rounded-xl">
                                <div className="text-xs text-muted-foreground mb-1">Active Vectors</div>
                    ...
                    <motion.div
                        ...
                        className="cyber-glass rounded-2xl p-6 border border-border h-80 relative overflow-hidden flex items-center justify-center group"
                    >
                        ...
                        <div className="absolute text-center z-10">
                            ...
                            <div className="text-[10px] text-muted-foreground italic px-4 leading-tight">
                ...
                <section className="col-span-12 lg:col-span-8 order-2 space-y-6">
                    ...
                    <motion.div
                        ...
                        className="cyber-glass rounded-3xl p-8 border border-border relative overflow-hidden"
                    >
                        {/* Progress Overlay */}
                        <AnimatePresence>
                            {isUploading && (
                                <motion.div
                                    ...
                                    animate={{ opacity: 1, y: 0 }}
                                    exit={{ opacity: 0, y: -20 }}
                                    className="absolute inset-0 z-50 bg-background/90 backdrop-blur-md flex flex-col items-center justify-center p-12 text-center"
                                >
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">The knowledge source for your project&apos;s AI agents.</p>
                            </div>
                            <div className="flex gap-3 w-full md:w-auto">
                                ...
                                <button
                                    ...
                                    className="flex-1 md:flex-none min-h-[44px] px-6 py-3 bg-cyan-500 text-slate-950 font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-cyan-400 transition-all active:scale-95 shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500/50"
                                >
                                    <Upload size={18} />
                                    Inject Data
                                </button>
                                <button type="button" className="min-w-[44px] min-h-[44px] p-3 bg-muted rounded-xl hover:bg-muted/80 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500/50" aria-label="Refresh">
                                    <RefreshCcw size={18} />
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            {datasets.map((data, idx) => (
                                <motion.div
                                    ...
                                    initial={{ opacity: 0, x: -20 }}
                                    animate={{ opacity: 1, x: 0 }}
                                    className="group p-5 bg-card/50 border border-border rounded-2xl hover:bg-cyan-500/5 hover:border-cyan-500/20 transition-all flex items-center justify-between"
                                >
                                    <div className="flex items-center gap-4">
                                        <div className="p-3 bg-card rounded-xl text-muted-foreground group-hover:text-cyan-400 transition-colors">
                                            <FileText size={24} />
                                        </div>
                                        <div>
                            ...
                            <button
                                type="button"
                                onClick={() => document.getElementById(FILE_INPUT_ID)?.click()}
                                className="w-full border-2 border-dashed border-border rounded-2xl p-10 flex flex-col items-center justify-center gap-3 hover:border-border/80 hover:bg-card/50 transition-all group"
                            >
                                <div className="w-10 h-10 rounded-full bg-card flex items-center justify-center text-muted-foreground group-hover:text-foreground transition-colors">
                                    <Plus size={20} />
                                </div>
                                <span className="text-xs text-muted-foreground font-mono">Initiate Neural Uplink</span>
                            </button>
                        </div>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="cyber-glass p-6 rounded-2xl border border-border">
                            <div className="text-muted-foreground text-[10px] uppercase mb-4 font-mono">Response Latency</div>
                            <div className="text-3xl font-black text-cyan-400 tracking-tighter">12ms</div>
                            <p className="text-[10px] text-muted-foreground mt-2">Ultra-fast vector retrieval via Cloudflare Workers.</p>
                        </div>
                        <div className="cyber-glass p-6 rounded-2xl border border-border">
                            <div className="text-muted-foreground text-[10px] uppercase mb-4 font-mono">Sync Accuracy</div>
                            <div className="text-3xl font-black text-purple-400 tracking-tighter">99.8%</div>
                            <p className="text-[10px] text-muted-foreground mt-2">High-fidelity retrieval-augmented generation.</p>
                        </div>
                        <div className="cyber-glass p-6 rounded-2xl border border-border">
                            <div className="text-muted-foreground text-[10px] uppercase mb-4 font-mono">Neural Safety</div>
                            <div className="text-3xl font-black text-green-400 tracking-tighter">ACTIVE</div>
                            <p className="text-[10px] text-muted-foreground mt-2">Real-time hallucination & toxicity filtering.</p>
                        </div>
                    </div>
                </section>
            ...
            <MobileDrawer open={drawerOpen} onClose={() => setDrawerOpen(false)} title="Stats & Neural Map">
                <div className="space-y-6">
                    <div className="cyber-glass rounded-2xl p-6 border border-cyan-500/20">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-muted-foreground font-mono uppercase">Neural Vector Engine v4.0</p>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 bg-card/50 border border-border rounded-xl">
                    ...
                    <div className="cyber-glass rounded-2xl p-6 border border-border h-48 relative overflow-hidden flex items-center justify-center">
